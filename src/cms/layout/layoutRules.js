...
export const DEFAULT_DEVICE_SPANS = {
  ...
  StoryRow: { rowSpan: 8, colSpan: 100 },
  CategoryGrid: { rowSpan: 10, colSpan: 100 },
  Carousel: { rowSpan: 20, colSpan: 100 },
  HeroBanner: { rowSpan: 20, colSpan: 100 },
  CouponCode: { rowSpan: 8, colSpan: 100 },
  CountDownTimer: { rowSpan: 8, colSpan: 100 },
  ProductList: { rowSpan: 35, colSpan: 100 },
  ProductCard: { rowSpan: 30, colSpan: 100 },
  Footer: { rowSpan: 25, colSpan: 100 },
  NavBar: { rowSpan: 6, colSpan: 100 },
  IFrame: { rowSpan: 18, colSpan: 100 },
  Box: { rowSpan: 15, colSpan: 100 },
  Title: { rowSpan: 4, colSpan: 100 },
  Description: { rowSpan: 4, colSpan: 100 },
  Text: { rowSpan: 3, colSpan: 100 },
  Badge: { rowSpan: 3, colSpan: 50 },
  Image: { rowSpan: 15, colSpan: 100 },
